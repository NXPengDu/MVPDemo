package com.nxedu.mvpdemo.ui.view;
 ...
 * @author Yan
 * @version 1.1.0
 * @since PANDA-COLLEGE-STUDENT 1.1.0
 */
public class ClearableEditText extends AppCompatEditText implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcher {
    ...
    private void init(final Context context) {
        Drawable drawable = ContextCompat.getDrawable(context, R.mipmap.abc_ic_clear_mtrl_alpha);
